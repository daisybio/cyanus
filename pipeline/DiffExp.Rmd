...
#saveRDS(sce,"../data/platelets/sceFilteredClustered.rds")
...
parameters <-  prepDiffExp(sce = sce_small_dual_ab, contrastVars = c("activated_baseline"), colsFixed = c("activated_baseline", "dual_triple"), colsRandom=c("patient_id"), method = "diffcyt-DS-LMM")
>>>>>>> master
