...
# put it in activated vs baseline section
CATALYST::plotExprs(
      sce,
      color_by = "activated_baseline",
      features = "state",
...
The clustering show no significant increase after meta6. Let's have a look at the clusters:
```{r}
CATALYST::plotAbundances(sce, "meta6", group_by = "activated_baseline") +  theme(text = element_text(size=18)) 
