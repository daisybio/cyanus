...
CATALYST::plotAbundances(sce, "meta9", by = "cluster_id", group_by = "patient_id", shape_by = "activated_baseline")

invisible(plotStarsCustom(sce, backgroundValues = cluster_codes(sce)[["meta9"]]))  #figure smaller machen # meta7 cluster machen
```
...
CATALYST::plotPbExprs(sce, k = "meta7", features = NULL , color_by = "activated_baseline", 
...
```{r,fig.with=12, fig.height=8}
CATALYST::plotPbExprs(sce, k = "meta2", features = NULL, color_by = "dual_triple", 
