...
clusteringBody <- tabItem(tabName = "clustering",
                          fluidRow(shinydashboard::box(
                            HTML(
                              "Choose from two clustering algorithms to detect and define cell populations for further downstream analysis:
        ...
        First group cells into clusters with FlowSOM using Self-Organizing Map clustering and Minimal Spanning Trees, <br>and subsequently perform metaclustering with ConsensusClusterPlus which determines cluster count and membership by stability evidence. <b>Time efficient - Recommended</b></li>
